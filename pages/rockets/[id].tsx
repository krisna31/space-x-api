...
const id = (props: any) => {
  ...
  return (
    <>
      {isDoneFetch ? <div className="flex flex-col justify-center items-center gap-2 mt-4 text-justify px-8 lg:px-32 mb-10">
      ...
      </div> : <h2 className="flex justify-center items-center text-4xl animate-bounce">Loading...</h2>}
    </>
  )
}
